...
using Background_Worker_App.Resources;
...
namespace Background_Worker_App
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void Button_PDFDownload(object sender, RoutedEventArgs e)
        {
            NavigationService.Navigate(new Uri("/PDFDownload.xaml", UriKind.Relative));
        }

        private void Button_ImageDownload(object sender, RoutedEventArgs e)
        {
            NavigationService.Navigate(new Uri("/ImageDownload.xaml", UriKind.Relative));
        }

        private void Button_TextFileDownload(object sender, RoutedEventArgs e)
        {
